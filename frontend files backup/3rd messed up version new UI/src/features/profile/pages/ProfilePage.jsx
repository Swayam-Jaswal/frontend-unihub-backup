          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
            {activeRoles.map((role) => (
              <article key={role._id} className="card-surface-muted p-4">
                ...
                <span className="mt-2 inline-block rounded-full border border-[hsl(var(--primary)/0.25)] bg-[hsl(var(--primary)/0.12)] px-2 py-0.5 text-xs text-[var(--color-text-primary)]">
                  Active
                </span>
              </article>
            ))}
