...
function StatCard({
  ...
  return (
    <article
      className="card-surface relative rounded-[var(--radius-xl)] p-5 transition-transform duration-300 hover:scale-[1.02] sm:p-6"
      style={{
    ...
    >
      <div className="flex items-center gap-4">
        <span
          className="inline-flex h-14 w-14 items-center justify-center rounded-[var(--radius-lg)] border border-white/5"
          style={{
